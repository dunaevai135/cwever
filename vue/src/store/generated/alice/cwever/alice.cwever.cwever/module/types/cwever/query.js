...
const baseQueryGetNextBatchRequest = {};
...
const baseQueryGetNextBatchResponse = {};
...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("alice.cwever.cwever.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    NextBatch(request) {
        const data = QueryGetNextBatchRequest.encode(request).finish();
        const promise = this.rpc.request("alice.cwever.cwever.Query", "NextBatch", data);
        return promise.then((data) => QueryGetNextBatchResponse.decode(new Reader(data)));
    }
}
