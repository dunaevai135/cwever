...
import AliceCweverAliceCweverCwever from './alice/cwever/alice.cwever.cwever'
...
export default { 
  AliceCweverAliceCweverCwever: load(AliceCweverAliceCweverCwever, 'alice.cwever.cwever'),
